...
public class CardViewBahasaAdapter extends RecyclerView.Adapter<CardViewBahasaAdapter.CardViewViewHolder> {
    ...
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_cardview_bahasa, viewGroup, false);
        ...
        holder.btnFavorite.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Toast.makeText(holder.itemView.getContext(), "Favorite " +
                                listBahasa.get(holder.getAdapterPosition()).getName(),
        ...
        holder.btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(holder.itemView.getContext(), "Share " +
                        listBahasa.get(holder.getAdapterPosition()).getName(), Toast.LENGTH_SHORT).show();
            }
        });
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(holder.itemView.getContext(), "Kamu memilih" + listBahasa
